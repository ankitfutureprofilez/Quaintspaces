...
const Book = () => {
  ...
  : "Dates not specified"}</h5> */}
            ...
            <h1 className="text-xl mb-4 font-medium mt-5 heading-data">
              Upload ID
            </h1>
            ...
            <div className="flex items-center justify-between w-full py-2 pb-4 border-b border-borderColor">
              <div className="ml-3 mt-4">
                ...
                <div className="flex flex-wrap justify-between mb-5">
                  ...
                  <p className="edit-color underline">ADD</p>
                </div>
            ...
            <div className="flex items-center justify-between w-full py-2 pb-4 border-b border-borderColor">
              <div className="ml-3 mt-4">
                ...
                <div className="flex flex-wrap ">
                  ...
                  <p className="underline edit-color">Learn More</p>
                </div>
              </div>
            </div>
            <div className="mt-5">
              <Button
                text={"Confirm & Pay"}
                design={
                  "font-inter font-lg leading-tight text-center text-white w-96 bg-orange-300  border-2 p-4 rounded-full"
                }
              />
            </div>
          </div>
          <div className="w-5/12  rounded-xl shadow py-8 px-5 h-fit golden-border">
            <div className="flex gap-3 pb-4 border-b border-borderColor image-data">
              {/* <Image src="" alt="Apartment" width={200} height={200} /> */}
