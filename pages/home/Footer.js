...
export default function Footer() {
  return (
    <div className="w-full flex flex-col justify-between bg-[#E6E6E6]">
      ...
      <div className="items-end footer-menu ">
        ...
        <div className="w-full mb-3 mb:mb-0">
          ...
          <div className="flex flex-col">
            <Link href="/terms">
              <span className="text-[#3F2A17] text-[16px] capitalize">Terms & Condition</span>
            </Link>
            <Link href="/policy">
              <span className="text-[#3F2A17] text-[16px] capitalize ]">Privacy Policy</span>
            </Link>
          </div>
        </div>
