    ...
    <div className="premium-location-slider" id="premium">
      <div className='container mx-auto '>
        ...
        <div className="relative flex items-center ">
          ...
          <button  onClick={slideNext} className="absolute -right-5 z-10 transform -translate-y-1/2 bg-gray-900 bg-opacity-50 text-white px-2 py-1 rounded-r">
        ...
        <span className='hidden'>Next Button</span>
          </button>
          <button className="absolute -left-5 z-10 transform -translate-y-1/2 bg-gray-900 bg-opacity-50 text-white px-2 py-1 rounded-r" onClick={slidePrev}>
        <svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
