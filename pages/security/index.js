...
<Button
                  ...
                  design={
                    "font-inter hover:bg-[#fff] text-white border-[#efa3a3] border hover:text-[#efa3a3] font-lg leading-tight text-center text-white w-full sm:w-96  sm:p-4 p-3 rounded-full mb-6 mt-6"
                  }
                />
</div>
              </form>
