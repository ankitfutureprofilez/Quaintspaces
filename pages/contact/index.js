  ...
  <img src="/images/EasySteps1.jpg" alt="Luxurious living room" className="rounded-lg shadow-lg" />
      ...
      <div className="container flex mx-auto w-full flex-wrap md:flex-nowrap space-x-7 mt-10">
        <div className="md:w-6/12 w-full">
          <h2
            className="capitalize text-xl sm:text-3xl text-lg  text-left font-semibold mb-4 lg:mb-8 mt-2.5 border-b pb-3 lg:pb-6"
            style={{ color: "#3F2A17" }}
          >
            Company info
          </h2>
          <div>
            {compantdetails?.map((item,index)=>(
               <>
               <p className="block text-sm font-medium uppercase text-gray-600">
               {item?.key}
               </p>
               <h3 className="capitalize text-lg sm:text-xl  text-left font-semibold mb-4 lg:mb-8 mt-2.5 pb-3 lg:pb-6"
                 style={{ color: "#3F2A17"}}>
            {item?.value}
               </h3>
               </> 
