          ...
          <div className="flex flex-wrap items-center">
            ...
            <div className="md:w-6/12 w-full px-0 md:px-6">
              <div>
                ...
                <p className="text-[16px] items-start flex text-[#000000] mb-[10px] max-w-xs">
                  <svg width="20" height="20" className="w-9 h-5 inline-block mt-[1px] align-middle" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
