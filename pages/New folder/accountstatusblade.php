    ...
    <table role="presentation" border="0" cellspacing="0" width="100%" style="font-family: 'Helvetica', MS Sans Serif, Arial;" >
      <tr>
        <td style="background-image: url(https://quaintstays.laraveldevelopmentcompany.com/public/img/hero-1.jpg); text-align: center; background-size: 100% 100%; background-position: bottom;">
          ...
          <h1 style="font-size: 1.5rem; color: #fff; font-weight: 700; text-align: center; margin: 0 auto; margin-bottom: 2.5rem; max-width: 360px; font-family: 'Helvetica', 'MS Sans Serif', Arial; text-transform: uppercase;">Your account has been @if($user['status']==1) Activated @endif @if($user['status']==0) Deactivated @endif</h1>
        </td>
      </tr>
      <tr>
      ...
      <tr>
        <td style="padding: 0 1.25rem;">
          <div style="background-color: rgba(255, 255, 255, 1); padding: 1.563rem 1.875rem; ">
            <p style="margin-bottom: 1.563rem; margin-top: 0rem; color: rgba(38, 38, 38, 1); font-size: 1rem; line-height: 1.5rem;">@if($user['status']==1) We are pleased to inform you that your account has been successfully activated! You can now enjoy full access to our platform and its features. We're excited to have you onboard and look forward to serving you.
             If you have any questions or need assistance getting started, please don't hesitate to contact our support team at {{$adminUser['email']}} or {{$adminUser['phone_no']}} .
             @endif  @if($user['status']==0)We regret to inform you that your account with Quientstays has been deactivated. This may be due to You have not used the account for a long time. If you believe this deactivation is a mistake or if you would like to appeal this decision, please reach out to our support team immediately at {{$adminUser['email']}} or {{$adminUser['phone_no']}}.
             Thank you for your understanding @endif.</p>
