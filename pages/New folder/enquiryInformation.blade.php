    ...
    <table role="presentation" border="0" cellspacing="0" width="100%" style="font-family: 'Helvetica', MS Sans Serif, Arial;" >
      <tr>
        <td style="background-image: url(https://quaintstays.laraveldevelopmentcompany.com/public/img/hero-1.jpg); text-align: center; background-size: 100% 100%; background-position: bottom;">
          <img style="margin-bottom: 2.5rem; margin-top: 1.875rem; " src="https://quaintstays.laraveldevelopmentcompany.com/public/img/Logo.png" alt="logo">
          <h1 style="font-size: 1.5rem; color: #fff; font-weight: 700; text-align: center; margin: 0 auto; margin-bottom: 2.5rem; max-width: 360px; font-family: 'Helvetica', 'MS Sans Serif', Arial; text-transform: uppercase;">Here is the information you requested in response to your inquiry</h1>
        </td>
      </tr>
      <tr>
        <td style="background-image: url(https://quaintstays.laraveldevelopmentcompany.com/public/img/hero-2.jpg); background-size: 100% 100%; background-position: top; padding: 0 1.25rem;">
          <div style="background-color: rgba(255, 255, 255, 1); padding: 1.563rem 1.875rem; ">
            <p style="margin-bottom: 1.563rem; color: rgba(38, 38, 38, 1); font-size: 1rem; line-height: 1.5rem;"> Dear @php echo ucwords($enquiry['name'])?? 'User'  @endphp,</p>
            <p style="margin: 0px; color: rgba(38, 38, 38, 1); font-size: 1rem; line-height: 1.5rem; line-height: 1.5rem;">Thank you for your inquiry! Here is your requested information in response to your inquiry.</p>
      ...
      <tr>
        <td style="padding: 0 1.25rem;">
          <div style="background-color: rgba(255, 255, 255, 1); padding: 1.563rem 1.875rem; ">
          <p style="margin: 0px; color: rgba(38, 38, 38, 1); font-size: 1rem; line-height: 1.5rem; line-height: 1.5rem;">@php echo ucwords($enquiry['message'])?? 'N/A'  @endphp.</p>
      ...
      <tr>
        <td style="padding: 0 1.25rem;">
          <div style="background-color: rgba(255, 255, 255, 1); padding: 1.563rem 1.875rem; ">
            ...
            <p style="margin-bottom: 0rem; margin-top: 0rem; color: rgba(38, 38, 38, 1); font-size: 1rem; line-height: 1.5rem;">Quaint Space</p>
          </div>
        </td>
      </tr>
      <tr>
        <td style="padding: 0 1.25rem;">
          <div style="text-align: center; ">
            <img style=" margin-top: 2.5rem; " src="https://quaintstays.laraveldevelopmentcompany.com/public/img/Logo.png" alt="logo">
