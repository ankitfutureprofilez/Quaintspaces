 ...
 <body style="margin: 0; padding: 0;">
   <div id="email" style="width:500px; margin: auto; background-color: rgba(255, 249, 243, 1);">  
    <table role="presentation" border="0" cellspacing="0" width="100%" style="font-family: 'Helvetica', MS Sans Serif, Arial;" >
      <tr>
        <td style="background-image: url(https://quaintstays.laraveldevelopmentcompany.com/public/img/image.png); text-align: center; background-size: 100% 100%; background-position: bottom;">
          ...
          <h1 style="font-size: 1.5rem; color: #fff; font-weight: 700; text-align: center; margin: 0 auto; margin-bottom: 2.5rem; max-width: 360px; font-family: 'Helvetica', 'MS Sans Serif', Arial; text-transform: uppercase;">Here is the information which user requested on your website for inquiry</h1>
        </td>
      </tr>
      <tr>
        <td style="background-image: url(https://quaintstays.laraveldevelopmentcompany.com/public/img/hero-2.jpg); background-size: 100% 100%; background-position: top; padding: 0 1.25rem;">
          <div style="background-color: rgba(255, 255, 255, 1); padding: 1.563rem 1.875rem; ">
            <p style="margin-bottom: 1.563rem; color: rgba(38, 38, 38, 1); font-size: 1rem; line-height: 1.5rem;"> Dear @php echo ucwords($enquiry['name'])?? 'User'  @endphp Team,</p>
            <p style="margin: 0px; color: rgba(38, 38, 38, 1); font-size: 1rem; line-height: 1.5rem; line-height: 1.5rem;">You have received a new enquiry through the Contact Us form on your website. Below are the details.</p>
      ...
      <tr>
        <td style="padding: 0 1.25rem;">
          <div style="background-color: rgba(255, 255, 255, 1); padding: 1.563rem 1.875rem; ">
          <p style="margin: 0px; color: rgba(38, 38, 38, 1); font-size: 1rem; line-height: 1.5rem; line-height: 1.5rem;"> Name: @php echo ucwords($enquiry['name'])?? 'N/A'  @endphp.</p>
          <p style="margin: 0px; color: rgba(38, 38, 38, 1); font-size: 1rem; line-height: 1.5rem; line-height: 1.5rem;"> 
            Email: @php echo ucwords($enquiry['email'])?? 'N/A'  @endphp.</p>
          <p style="margin: 0px; color: rgba(38, 38, 38, 1); font-size: 1rem; line-height: 1.5rem; line-height: 1.5rem;"> Message: @php echo ucwords($enquiry['message'])?? 'N/A'  @endphp.</p>
      ...
      <tr>
        <td style="padding: 0 1.25rem;">
          <div style="text-align: center; ">
            <img style=" margin-top: 2.5rem; " src="https://quaintstays.laraveldevelopmentcompany.com/public/img/image.png" alt="logo">
