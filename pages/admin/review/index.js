                  ...
                  <div className="overflow-x-auto border border-gray-200 dark:border-gray-700 md:rounded-lg">
                    <table className="min-w-[1200px] w-full table-auto break-all divide-y divide-gray-200 dark:divide-gray-700">
                      <thead className="bg-indigo-600 ">
                        <tr>
                          <th className="px-4 py-4 text-sm w-[12vh] font-normal text-left rtl:text-right text-white dark:text-gray-400 ">
                            S.No.
                          </th>
                          <th className="px-4 py-4 text-sm w-[24vh] font-normal text-left rtl:text-right text-white dark:text-gray-400 ">
                            Date
                          </th>
                          <th className="px-4 py-4 text-sm w-[35vh] font-normal text-left rtl:text-right text-white dark:text-gray-400 ">
                            Customer
                          </th>
                          <th className="px-4 py-4w-[10vh] text-sm font-normal text-left rtl:text-right text-white dark:text-gray-400">
                            Description
                          </th>
                          <th className="px-4 py-4 text-sm w-[50vh] font-normal text-left rtl:text-right text-white dark:text-gray-400 ">
                            Property
                          </th>
                          <th className="px-4 py-4 text-sm w-[10vh] font-normal text-left rtl:text-right text-white dark:text-gray-400 ">
                            Status
                          </th>
                          <th className="px-4 py-4 text-sm  w-[10vh] font-normal text-left rtl:text-right text-white dark:text-gray-400 ">
                            Actions
