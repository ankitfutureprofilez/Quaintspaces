                  ...
                  <div className="overflow-x-auto border border-gray-200 dark:border-gray-700 md:rounded-lg">
                    <table className="min-w-[1200px] w-full table-auto divide-y divide-gray-200 dark:divide-gray-700">
                      <thead className="bg-indigo-600">
                        <tr>
                          <th className="px-4 py-4 text-sm w-1/12 font-normal text-left rtl:text-right text-white dark:text-gray-400">
                            S.No.
                          </th>
                          <th className="px-4 py-4 text-sm w-3/12 font-normal text-left rtl:text-right text-white dark:text-gray-400">
                            Date
                          </th>
                          <th className="px-4 py-4 text-sm w-3/12 font-normal text-left rtl:text-right text-white dark:text-gray-400">
                            Customer
                          </th>
                          <th className="px-4 py-4 text-sm w-2/12 font-normal text-left rtl:text-right text-white dark:text-gray-400">
                            Description
                          </th>
                          <th className="px-4 py-4 text-sm w-2/12 font-normal text-left rtl:text-right text-white dark:text-gray-400">
                            Property
                          ...
                          <th className="px-4 py-4 text-sm w-28 font-normal text-left rtl:text-right text-white dark:text-gray-400">
                            Actions
                          </th>
                        </tr>
                      </thead>
