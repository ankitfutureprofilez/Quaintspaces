            ...
            {loading ? (
              ...
              <>
                ...
                <div className="container mx-auto flex">
                  <div className="w-1/3">
                    <div className="flex items-center" onClick={() => router.back(-1)}>
                      <IoArrowBack size={24} />
                      <h2 className="text-lg font-bold">Listing Editor</h2>
                    </div>
                    ...
                    {editguide === "guide" && (
                      <>
                        <div className=" p-4 overflow-y-auto" style={{ maxHeight: 'calc(100vh - 150px)' }}>
                          <div
                            className={`cursor-pointer border border-gray-300 rounded-md p-4 mt-3 ${expandedIndex === 0 && "hover:text-black bg-border-600 bg-gray-300"
                              }`}
                          ...
                          <div
                            className={`cursor-pointer border border-gray-300 rounded-md p-4 mt-3 ${expandedIndex === 1 && "hover:text-black bg-border-600 bg-gray-300"
                              }`}
                          ...
                          <div
                            className={`cursor-pointer border border-gray-300 rounded-md p-4 mt-3 ${expandedIndex === 2 && "hover:text-black bg-border-600 bg-gray-300"
                              }`}
                          ...
                          <div
                            className={`cursor-pointer border border-gray-300 rounded-md p-4 mt-3 ${expandedIndex === 3 && "hover:text-black bg-border-600 bg-gray-300"
                              }`}
                          ...
                          <div
                            className={`cursor-pointer border border-gray-300 rounded-md p-4 mt-3 ${expandedIndex === 4 && "hover:text-black bg-border-600 bg-gray-300"
                              }`}
                          ...
                          <div
                            className={`cursor-pointer border border-gray-300 rounded-md p-4 mt-3 ${expandedIndex === 5 && "hover:text-black bg-border-600 bg-gray-300"
                              }`}
                          ...
                          <div
                            className={`cursor-pointer border border-gray-300 rounded-md p-4 mt-3 ${expandedIndex === 6 && "hover:text-black bg-border-600 bg-gray-300"
                              }`}
                    ...
                    {editguide === "space" && (
                      <>
                        <div className=" p-4 overflow-y-auto" style={{ maxHeight: 'calc(100vh - 150px)' }}>
                          <div
                            className={` hover:bg-gray-300 active:bg-gray-300 cursor-pointer border border-gray-300 rounded-md p-4 mt-3 ${expandedIndex === 0 && "hover:text-black bg-border-600 bg-gray-300 bg-gray-300"
                              }`}
                            onClick={() => toggleExpanded(0)}
                          >
                          ...
                          <div
                            className={`cursor-pointer border border-gray-300 rounded-md p-4 mt-3 ${expandedIndex === 7 && "hover:text-black bg-border-600 bg-gray-300"
                              }`}
                          ...
                          <div
                            className={`cursor-pointer border border-gray-300 rounded-md p-4 mt-3 ${expandedIndex === 8 && "hover:text-black bg-border-600 bg-gray-300"
                              }`}
                          ...
                          <div
                            className={`cursor-pointer border border-gray-300 rounded-md p-4 mt-3 ${expandedIndex === 9 && "hover:text-black bg-border-600 bg-gray-300"
                              }`}
                          ...
                          <div
                            className={`cursor-pointer border border-gray-300 rounded-md p-4 mt-3 ${expandedIndex === 10 && "hover:text-black bg-border-600 bg-gray-300"
                              }`}
                  ...
                  {editguide === "space" && (
                    <div className="w-2/3 m-4 p-4">
                      {expandedIndex === 0 && (
                        <div className="h-screen flex justify-center items-center px-4">
                          <div className="w-full max-w-lg">
                            <h2 className="font-bold font-[16px] text-center ">Property Name </h2>
                            <textarea
                              required
                              id="about"
                              name="name"
                              ...
                              className="mt-1 block w-full border border-gray-300 bg-white min-h-[300px] rounded-xl shadow-sm focus:outline-0 focus:border-indigo-500 text-normal p-4"
                      ...
                      {expandedIndex === 4 && (
                       ...
                       <div className="p-4 w-full max-w-2xl bg-white  rounded-xl">
                        ...
                        {expandedIndex === 2
                          && (
                            <div className="flex flex-col justify-center items-center h-screen">
                              <h1 className="capitalize text-lg font-bold my-4 text-center">
                                Wifi details
                              </h1>
                              <label
                                htmlFor="wifi"
                                className="block font-medium text-gray-700 my-2 text-center"
                              >
                                Wifi Name
                              </label>
                              <input
                                ...
                                name="wifi"
                                type="text"
                                className="shadow-sm p-4 py-2 w-full max-w-md mt-1 block sm:text-sm border rounded-xl text-center"
                              ...
                              <input
                                ...
                                name="wifiPassword"
                                type="text"
                                className="shadow-sm p-4 py-2 w-full max-w-md mt-1 block text-[16px] md:text-lg border rounded-xl text-center"
