            ...
            <>
                {isLoading ? (
                    ...
                    <>
                        ...
                        <div className="">
                            <h2 className="md:text-[32px] text-[20px] font-bold text-black mb-1 md:mb-3">Welcome back, {Admin}</h2>
                            <p className="md:text-[22px] text-[16px]  text-black mb-3">Finish your listing</p>
                            <div >
                                {record && record.map((item, index) => (
                                    <div className="p-4 border rounded-xl mb-2 flex items-center" key={index} style={{ cursor: "pointer" }} onClick={() => handleEditEntireProperty(item?.uuid)}>
                                        ...
                                        <h2 className="md:text-lg  text-[16px] font-medium md:ml-4 ml-2 ">{item.name || "please name "}</h2>
                                    </div>
                                ))}
                            </div>
                        </div>
                        <div className="mt-8">
                            <h2 className="md:text-[22px] text-[18px]   text-black mb-3">
                                Start a new listing
                            </h2>
                            <div className="p-4 border-b mb-2 flex items-center relative" style={{ cursor: "pointer" }} onClick={() => {
                                ...
                                <h2 className="md:text-lg  text-[16px]  font-medium ml-4  " >
