            ...
            <div className='w-full h-full bg-white border-r'>
                ...
                <div className='flex flex-col h-full justify-between'>
                    ...
                    <div className='pt-6 text-gray-500 font-medium space-y-2 md:px-2 text-xs'>
                        ...
                        <Link href={'/admin/app/teams'} className={`flex ${pathname === '/admin/app/teams' ? 'text-primary' : ''} hover:px-8 duration-200 px-6 py-2 items-center gap-2`}>
                            <Profile2User size={16} />
                            Teams
                        </Link>

                        <Link href={'/admin/app/integrations'} className={`flex ${pathname === '/admin/app/integrations' ? 'text-primary' : ''} hover:px-8 duration-200 px-6 py-2 items-center gap-2`}>
                            <Setting4 size={16} />
                            Integrations
                        </Link>
